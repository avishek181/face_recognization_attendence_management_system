...
class Face_Recognition:
    def __init__(self, root):
            ...
            # first image
            img_top = r"college_images\face_detector1.jpg"
            img = Image.open(img_top)
            img = img.resize((650, 700))
            ...
            # second image
            img_bottom = r"college_images\face11.jpg"
            ...
            b1_1 = Button(self.root, text="Face Recognition",command=self.face_recog,cursor="hand2",font=("times new roman",18,"bold"),bg="darkgreen",fg="white" )  # ✅ Use self.photoimg5 (lowercase "p")
            b1_1.place( x=1000, y=680, width =200, height=40)
